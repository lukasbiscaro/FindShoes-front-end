                ...
                <nav className="relative z-50 flex justify-between">
                    <div className="flex items-center md:gap-x-12">
                        ...
                        <div className="hidden md:flex md:gap-x-6">
                            <Link className="inline-block py-1 px-2 text-sm text-white hover:border-b-2 hover:border-highlightPrimary2 hover:text-highlightPrimary2" to={'exploreItems'}>Explore Items</Link>
                        </div>
                    </div>
                        ...
                        <div className="hidden md:flex">
                            <form name="search" action="#" method="post">
                                <div className="relative flex w-full flex-wrap items-stretch">
                                    <input
                                        type="search"
                                        className="text-white relative m-0 block min-w-0 w-52 leading-[22px] flex-auto border border-solid border-opacity-20 border-highlightPrimary2 bg-transparent bg-clip-padding py-2 pl-3 pr-12 leading-2 text-base font-normal outline-none transition duration-300 ease-in-out focus:border-primary-600  focus:shadow-te-primary focus:outline-none focus:ring-1 focus:ring-highlightPrimary placeholder:text-white placeholder:text-opacity-30"
                                        placeholder="Search..."
                                        aria-label="Search"
