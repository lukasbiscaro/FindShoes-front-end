                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="py-16">
                        <div className='flex justify-center'>
                            <Link aria-label="Home" to="/" className='flex justify-center'>
                    ...
                    <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                        <div className="flex gap-x-6">
                            <Link className="group" aria-label="FindShoes on Twitter" to="https://twitter.com">
                            ...
                            <Link className="group" aria-label="FindShoes on GitHub" to="https://github.com">
                                <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
