                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="py-16">
                        <div className='flex justify-center'>
                            <a aria-label="Home" href="/" className='flex justify-center'>
                        ...
                        <nav class="mt-10 text-sm" aria-label="quick links">
                            <div class="-my-1 flex justify-center gap-x-6">
                                <a class="inline-block rounded-lg py-1 px-2 text-sm text-white hover:opacity-80 hover:text-gray-400" href="/collections">Collections</a>
                                <a class="inline-block rounded-lg py-1 px-2 text-sm text-white hover:opacity-80 hover:text-gray-400" href="/exploreItems">Explore Items</a>
                            </div>
                        </nav>
                    </div>
                    <div class="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                        <div class="flex gap-x-6">
                            <a class="group" aria-label="FindShoes on Twitter" href="https://twitter.com">
                            ...
                            <a class="group" aria-label="FindShoes on GitHub" href="https://github.com">
                                <svg aria-hidden="true" class="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
                        ...
                        <p class="mt-6 text-sm text-white sm:mt-0">
                            Copyright © 2023 FindShoes Marketplace. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
