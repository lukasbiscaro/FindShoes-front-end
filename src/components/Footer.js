                    ...
                    <div className="py-16">
                        ...
                        <nav className="mt-10 text-sm" aria-label="quick links">
                            <div className="-my-1 flex justify-center gap-x-6">
                                <a className="inline-block rounded-lg py-1 px-2 text-sm text-white hover:opacity-80 hover:text-gray-400" href="/collections">Collections</a>
                                <a className="inline-block rounded-lg py-1 px-2 text-sm text-white hover:opacity-80 hover:text-gray-400" href="/exploreItems">Explore Items</a>
                            </div>
                        </nav>
                    </div>
                    <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                        <div className="flex gap-x-6">
                            <a className="group" aria-label="FindShoes on Twitter" href="https://twitter.com">
                            ...
                            <a className="group" aria-label="FindShoes on GitHub" href="https://github.com">
                                <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
