                    ...
                    <nav className="relative z-50 flex justify-between">
                        ...
                        <div className="flex items-center gap-x-3 md:gap-x-3">
                            ...
                            <div className="hidden md:flex md:gap-x-3">
                                <a className="transition-all duration-500 ease-in-out group inline-flex items-center justify-center py-2 px-6 text-sm focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 border-2 border-highlightPrimary text-highlightPrimary hover:text-white hover:bg-highlightPrimary hover:font-bold active:bg-highlightPrimary2 active:text-blue-100 focus-visible:outline-highlightPrimary2 uppercase font-light" href="/login">
                                    <span>log in</span>
                                </a>
                                <a className="transition-all duration-500 ease-in-out group inline-flex items-center justify-center py-2 px-6 text-sm font-light focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 border-2 border-highlightPrimary bg-highlightPrimary text-white hover:text-black active:bg-highlightPrimary2 active:text-blue-100 focus-visible:outline-highlightPrimary2 uppercase hover:font-bold" href="/sign-up">
                                    <span>Sign up</span>
                                </a>
                            </div>
